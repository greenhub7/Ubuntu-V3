        ...
        return (
            <>
                <div id="about" tabIndex="0" onFocus={this.changeScreen} className={(this.state.active_screen === "about" ? " bg-ub-orange bg-opacity-100 hover:bg-opacity-95" : " hover:bg-gray-50 hover:bg-opacity-5 ") + " w-28 md:w-full md:rounded-none rounded-sm cursor-default outline-none py-1.5 focus:outline-none duration-100 my-0.5 flex justify-start items-center pl-2 md:pl-2.5"}>
                    <img className=" w-3 md:w-4" alt="vexpro" src="./themes/Yaru/status/about.svg" />
    ...
    return (
        <>
            <div className="w-20 md:w-28 my-4 bg-white rounded-full">
                <img className="w-full" src="./images/logos/fevicon.png" alt="VexPro Logo" />
            </div>
            <div className=" mt-4 md:mt-8 text-lg md:text-2xl text-center px-1">
                <div>This is <span className="font-bold">VexPro</span> ,</div>
                <div className="font-normal ml-1">work as <span className="text-pink-600 font-bold">Web & AI Engineer!</span></div>
            </div>
            ...
            <ul className=" mt-4 leading-tight tracking-tight text-sm md:text-base w-5/6 md:w-3/4 emoji-list">
                <li className=" list-pc">I'm a Experienced and passionate <span className=" font-medium">AI/ML Engineer and Senior Full Stack Developer</span> with over 7 years of hands-on experience.  <u className=' cursor-pointer '> </u>, and now I'm looking for Full-time computer engineer roles! ( Contact with me <a className='text-underline' href='mailto:freeburner80@gmail.com'><u>freeburner80@gmail.com</u></a> :) )</li>

...
export class Chrome extends Component {
    constructor() {
        super();
        this.home_url = 'https://vexpro-v2.netlify.app/';
        this.state = {
            url: 'https://vexpro-v2.netlify.app/',
            display_url: "https://vexpro-v2.netlify.app/",
        }
    }
    ...
    goToHome = () => {
        this.setState({ url: this.home_url, display_url: "https://vexpro-v2.netlify.app/" });
        this.refreshChrome();
    }
